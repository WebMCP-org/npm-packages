...
If you’d like to discuss Diátaxis with other users, please see the _#diataxis_ channel on the
[Write the Docs Slack group](https://www.writethedocs.org/slack/), or the [Discussions](https://github.com/evildmp/diataxis-documentation-framework/discussions) section of the [GitHub
repository for this website](https://github.com/evildmp/diataxis-documentation-framework).
...
APA and BibTeX metadata are available from the _Cite this repository_ option at
[https://github.com/evildmp/diataxis-documentation-framework](https://github.com/evildmp/diataxis-documentation-framework).
