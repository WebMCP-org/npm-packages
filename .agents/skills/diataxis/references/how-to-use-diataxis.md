...
better, even smaller, a paragraph or a sentence. Challenge it, according to the standards Diátaxis prescribes: _What
user need is represented by this? How well does it serve that need? What can be added, moved, removed or changed to
serve that need better? Do its language and logic meet the requirements of this mode of documentation?_

**Decide what to do**. Decide, based on your answers to those questions: _What single next action will produce an
immediate improvement here?_
...
_Illustration copyright [Linette Voller](https://linettevoller.com) 2021, reproduced with kind permission.¶_
