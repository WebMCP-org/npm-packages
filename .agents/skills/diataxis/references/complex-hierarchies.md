...
have an inherent mechanical order - numerical, or alphabetical. _Seven items
seems to be a comfortable general limit._ If you find that you’re looking at
...
introduce them. _Remember that you are always authoring for a human user, not
fulfilling the demands of a scheme._
...
began with, that’s not a problem - as long as there _is_
