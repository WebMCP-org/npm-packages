  ...
  socialProof: {
    items: [
      ...
      },
      {
        ...
        image: '/assets/social-proof/media/jack-herrington-webmcp.webp',
      },
      {
      ...
      },
      {
        ...
        image: '/assets/social-proof/media/ai-tinkerers-webmcp.webp',
      },
      {
        ...
        image: '/assets/social-proof/media/zuplo-webmcp.webp',
      },
    ],
  },
  demoSection: {
