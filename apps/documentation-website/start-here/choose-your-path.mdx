...
<Steps>
  ...
  <Step title="Full runtime: @mcp-b/global">
    Add the MCP-B runtime layer on top of the core. Use this when you need transport, prompts, resources, browser-to-desktop connectivity, or MCP metadata discovery through `listTools()`.
  ...
  <Step title="React hooks: @mcp-b/react-webmcp or usewebmcp">
    **`@mcp-b/react-webmcp`** provides hooks for the full MCP-B runtime, including provider and client patterns, schema support, and execution state tracking.
