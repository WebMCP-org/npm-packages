---
title: 'ChatGPT and Codex WebMCP site tools compatibility'
description: "Compare OpenAI site tools in ChatGPT's built-in browser with the WebMCP Community Group draft and current MCP-B compatibility guidance."
keywords:
  [
    'ChatGPT WebMCP',
    'Codex WebMCP',
