...
keywords:
  ['WebMCP', 'WebMCP API', 'WebMCP proposal', 'document.modelContext', 'AI agents', 'browser tools']
...
implementation questions to their upstream owners. [WebMCP resources and
status](/explanation/design/spec-status-and-limitations) collects status,
