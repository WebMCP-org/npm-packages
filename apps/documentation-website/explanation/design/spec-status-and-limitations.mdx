...
implementations, and MCP-B packages can change on separate schedules. Check
the live implementation sources below for current Chrome, Edge, Firefox, and
Safari support rather than assuming that proposal support implies browser
availability.
