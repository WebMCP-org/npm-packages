...
`callTool()`, prompts, resources, sampling, elicitation, and browser
transports. These capabilities are exposed by `BrowserMcpServer`,
`@mcp-b/global`, and related packages. They are MCP-B extensions, not standard
WebMCP methods.
