...
<Warning>
  If `outputSchema` is defined, the tool implementation must return a JSON-serializable object.
  Returning a non-object value (`string`, `null`, array) causes an error response.
</Warning>
