...
Read the [`@mcp-b/react-webmcp` reference](/packages/react-webmcp/reference) for optional execution state,
...
direct browser registrations. Use `usewebmcp` for tool registration and raw results. Add an
[execution-state plugin](https://github.com/WebMCP-org/npm-packages/tree/main/packages/webmcp-plugins#execution-state)
and subscribe only where the UI needs it. Use
