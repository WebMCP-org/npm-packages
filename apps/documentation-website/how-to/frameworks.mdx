...
| Package                                                   | Use it when                                                              |
| --------------------------------------------------------- | ------------------------------------------------------------------------ |
| [`usewebmcp`](/packages/usewebmcp/reference)              | Your component only registers WebMCP tools.                              |
| [`@mcp-b/react-webmcp`](/packages/react-webmcp/reference) | Your app also registers prompts or resources, or consumes an MCP server. |
...
Use `usewebmcp` when you only need tool registration and local execution state. Use
