...
<Frame>
  <img
    ...
    alt="Re-renders for 10 description changes: usewebmcp 20, MCP-B React 20, MCP Cat 10, Google 20. For 10 overlapping calls, start to finish: 11, 11, 20; Google exposes no execution state."
  />
  <img
