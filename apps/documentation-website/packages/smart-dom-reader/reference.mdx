...
The separate `@mcp-b/smart-dom-reader-server` package uses
`@modelcontextprotocol/server` v2 and returns XML-wrapped Markdown. Output format:
...
- [Use Chrome DevTools MCP](/how-to/use-devtools-mcp) (upstream DevTools-based browser automation)
