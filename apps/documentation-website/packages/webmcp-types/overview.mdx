...
`@mcp-b/webmcp-types` is the lowest-level package in the MCP-B stack. It provides `document.modelContext` contracts, schema inference utilities, and browser global augmentation without runtime code.
