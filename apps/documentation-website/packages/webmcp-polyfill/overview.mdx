...
Initialize the polyfill before your app registers tools. The [reference page](/packages/webmcp-polyfill/reference) documents initialization, declarative forms, testing shim behavior, and the strict-core lifecycle.
