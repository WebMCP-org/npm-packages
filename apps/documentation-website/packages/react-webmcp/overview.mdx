...
<Frame>
  <img
    ...
    alt="Choose usewebmcp for raw browser tools or @mcp-b/react-webmcp for MCP features. Both use your schema library and runtime."
  />
  <img
...
`'use client'`. See the [React commit comparison](/packages/usewebmcp/overview#react-updates-measured).
