...
<CardGroup cols={2}>
  <Card title="@mcp-b/webmcp-types" icon="boxes-stacked" href="/packages/webmcp-types/overview">
    Zero-runtime TypeScript types for the WebMCP core surface, schema inference, and Navigator
    augmentation.
  </Card>
  <Card
...
<CardGroup cols={2}>
  ...
  >
    Chrome DevTools Protocol bridge that lets MCP clients inspect browsers and discover WebMCP tools
    from live pages.
  </Card>
  <Card
