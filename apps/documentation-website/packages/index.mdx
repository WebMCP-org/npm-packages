...
<CardGroup cols={2}>
  ...
  <Card title="@mcp-b/webmcp-polyfill" icon="boxes-stacked" href="/packages/webmcp-polyfill/overview">
    Strict WebMCP runtime polyfill for document.modelContext in browsers that do not ship the API yet.
  </Card>
...
<CardGroup cols={2}>
  <Card title="usewebmcp" icon="boxes-stacked" href="/packages/usewebmcp/overview">
    Strict-core React hook for registering document.modelContext tools without the broader MCP-B runtime layer.
  </Card>
