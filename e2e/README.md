...
`packages/chrome-devtools-mcp` uses a separate install path from the default workspace. See [`docs/VENDORED_UPSTREAM_FORKS.md`](../docs/VENDORED_UPSTREAM_FORKS.md) before working on that lane.
