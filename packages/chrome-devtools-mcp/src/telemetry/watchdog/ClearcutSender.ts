...
import type { ChromeDevToolsMcpExtension, LogRequest, LogResponse, OsType } from '../types.js';
...
export class ClearcutSender {
  ...
  constructor(config: ClearcutSenderConfig) {
    ...
    this.#flushIntervalMs = config.forceFlushIntervalMs ?? DEFAULT_FLUSH_INTERVAL_MS;
